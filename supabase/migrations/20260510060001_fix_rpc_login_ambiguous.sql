-- ─────────────────────────────────────────────────────────────
-- fix: rpc_login had ambiguous "username" reference
-- ─────────────────────────────────────────────────────────────
...
declare
    ...
    valid      boolean := false;
begin
    select * into la from public.login_attempts a where a.username = p_username;
    ...
    if valid then
        delete from public.login_attempts a where a.username = p_username;
